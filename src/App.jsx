        ...
        {sidebarView === "reports" && (
          <Section title="Reports">
            <div className="space-y-6">
              ...
              <div className="rounded-[24px] border border-emerald-100 bg-white/90 p-5">
                <div className="mb-3 text-lg font-bold text-slate-950">Semen Stock Report Period</div>
                ...
                <div className="mt-2 text-sm text-slate-600">Choose Overall for whole financial year, or select a month for month-wise semen stock report.</div>
              </div>
              ...
              <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
                ...
                <button className="rounded-[26px] border border-slate-200/70 bg-white/95 p-5 text-left shadow-[0_12px_28px_rgba(15,23,42,0.06)] transition hover:-translate-y-1 hover:shadow-lg" onClick={() => exportDairyScopeReport("semenStock")}>
                  <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-emerald-50 text-xl">🧪</div>
                    ...
                    <div className="rounded-2xl border border-emerald-100 bg-white p-4 shadow-sm">
                      ...
                      <div className="overflow-x-auto rounded-[24px] border border-slate-100 bg-white/70">
                        <table className="min-w-[1500px] border-collapse text-sm">
                          <thead className="bg-slate-50/90"><tr className="bg-emerald-50 text-left text-emerald-900">{["Opening balance","Semen doses produced","Date of production","Semen doses sold","Date of sale","Issued to Farm","Date","Issued to GADVASU","Date","Used for experiments","Date","Closing balance"].map((h)=><th key={h} className="border border-emerald-100 px-2 py-2 whitespace-nowrap">{h}</th>)}</tr></thead>
                          <tbody>
                            {(activeAnimal.maleDetails.semenStockRecords || []).map(cleanSemenStockRecord).map((rec, idx) => (
                              <tr key={`semen-${idx}`}>
                                <td className="border border-emerald-100 px-2 py-2"><input className="w-full rounded-xl border border-emerald-100 px-2 py-2" value={rec.openingBalance || ""} onChange={(e) => updateSemenStockRecord(idx, "openingBalance", e.target.value)} /></td>
                                <td className="border border-emerald-100 px-2 py-2"><input className="w-full rounded-xl border border-emerald-100 px-2 py-2" value={rec.dosesProduced || ""} onChange={(e) => updateSemenStockRecord(idx, "dosesProduced", e.target.value)} /></td>
                                <td className="border border-emerald-100 px-2 py-2"><DateInput value={rec.productionDate || ""} onChange={(v) => updateSemenStockRecord(idx, "productionDate", v)} /></td>
                                <td className="border border-emerald-100 px-2 py-2"><input className="w-full rounded-xl border border-emerald-100 px-2 py-2" value={rec.dosesSold || ""} onChange={(e) => updateSemenStockRecord(idx, "dosesSold", e.target.value)} /></td>
                                <td className="border border-emerald-100 px-2 py-2"><DateInput value={rec.saleDate || ""} onChange={(v) => updateSemenStockRecord(idx, "saleDate", v)} /></td>
                                <td className="border border-emerald-100 px-2 py-2"><input className="w-full rounded-xl border border-emerald-100 px-2 py-2" value={rec.dosesIssuedFarm || ""} onChange={(e) => updateSemenStockRecord(idx, "dosesIssuedFarm", e.target.value)} /></td>
                                <td className="border border-emerald-100 px-2 py-2"><DateInput value={rec.farmIssueDate || ""} onChange={(v) => updateSemenStockRecord(idx, "farmIssueDate", v)} /></td>
                                <td className="border border-emerald-100 px-2 py-2"><input className="w-full rounded-xl border border-emerald-100 px-2 py-2" value={rec.dosesIssuedGadvasu || ""} onChange={(e) => updateSemenStockRecord(idx, "dosesIssuedGadvasu", e.target.value)} /></td>
                                <td className="border border-emerald-100 px-2 py-2"><DateInput value={rec.gadvasuIssueDate || ""} onChange={(v) => updateSemenStockRecord(idx, "gadvasuIssueDate", v)} /></td>
                                <td className="border border-emerald-100 px-2 py-2"><input className="w-full rounded-xl border border-emerald-100 px-2 py-2" value={rec.dosesUsedExperiments || ""} onChange={(e) => updateSemenStockRecord(idx, "dosesUsedExperiments", e.target.value)} /></td>
                                <td className="border border-emerald-100 px-2 py-2"><DateInput value={rec.experimentDate || ""} onChange={(v) => updateSemenStockRecord(idx, "experimentDate", v)} /></td>
                                <td className="border border-emerald-100 bg-emerald-50 px-2 py-2 text-center font-bold text-emerald-900">{calculateSemenClosingBalance(rec)}</td>
                              </tr>
                            ))}
                          </tbody>
                        </table>
