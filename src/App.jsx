...
function buildHerdStrengthReport(animals, fyStartYear, monthLabel) {
  ...
  const dry = present.filter((a) => {
    const lifecycle = femaleLifecycle(a);
    return a.category === "Female" && (ageDaysOnDate(a, asOfDate) || 0) > 365 && (lifecycle === "Dry" || lifecycle === "Colostrum");
  }).length;
  const heifer = present.filter((a) => {
    const lifecycle = femaleLifecycle(a);
    return a.category === "Female" && (ageMonthsOnDate(a, asOfDate) || 0) > 36 && (lifecycle === "Heifer" || lifecycle === "Colostrum-Heifer");
  }).length;
  ...
  const youngFemale = (a) => {
    const lifecycle = femaleLifecycle(a);
    return a.category === "Female" && (lifecycle === "Heifer" || lifecycle === "Colostrum-Heifer");
  };
